...
from universal_security_scanner.scanner.source_analysis import find_flow_match
...
def verify_finding(context: ValidationContext) -> ValidationResult:
    ...
    command = (
        "python -m universal_security_scanner.poc_verify verify "
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="python -m universal_security_scanner.poc_verify")
