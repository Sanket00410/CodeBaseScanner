...
from universal_security_scanner.models import ScanStatusResponse, StartScanRequest, StartScanResponse
...
app = FastAPI(title="Universal Security Scanner", version="1.0.0")
