...
### A. Experience Layer
- SecureScope desktop app (Electron + React): operator UX, live progress, triage.
...
flowchart TB
    subgraph UX["Experience Layer"]
        Desktop["SecureScope Desktop (Electron + React)"]
        CLI["CLI / CI Runner"]
        IDE["IDE Extension"]
...
sequenceDiagram
    ...
    participant UI as SecureScope UI
...
Everything below extends your current stack in universal_security_scanner + SecureScope.
...
Add: replay_pack object on each finding + export folder exports/replay/<scan_id>/<finding_uid>/.
Files:
universal_security_scanner/scanner/engine.py
universal_security_scanner/scanner/reporting/report_builder.py
universal_security_scanner/scanner/reporting/exporters.py
SecureScope/backend/types.ts
SecureScope/frontend/src/types.ts
SecureScope/backend/exportService.ts
SecureScope/frontend/src/App.tsx
...
Files:
universal_security_scanner/scanner/reporting/report_builder.py
universal_security_scanner/scanner/scan_control.py
universal_security_scanner/scanner/file_discovery.py
SecureScope/backend/types.ts
SecureScope/frontend/src/App.tsx
...
Files:
universal_security_scanner/scanner/controls/analyzer.py
universal_security_scanner/scanner/reporting/report_builder.py
SecureScope/frontend/src/App.tsx
...
Files:
universal_security_scanner/scanner/reporting/report_builder.py
universal_security_scanner/scanner/rules/dependency_rules.py
