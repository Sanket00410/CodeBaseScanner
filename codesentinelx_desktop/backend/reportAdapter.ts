...
export function toHistoryItem(record: ScanRecord): ScanHistoryItem {
  ...
  return {
    ...
    criticalFindings: Number(summary.severity_distribution?.Critical || 0),
    highFindings: Number(summary.severity_distribution?.High || 0),
    mediumFindings: Number(summary.severity_distribution?.Medium || 0),
    lowFindings: Number(summary.severity_distribution?.Low || 0),
    infoFindings: Number(summary.severity_distribution?.Info || 0),
